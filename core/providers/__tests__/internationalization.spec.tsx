...
import { InternationalizationProvider, InternationalizationProviderLib } from '../internationalization'

describe('Testing [providers] => internationalization', () => {
  it("should store user's current language in it's atom", () => {
    const { result } = renderHook(InternationalizationProviderLib.H.useInternationalization, commonHookRenderer)
